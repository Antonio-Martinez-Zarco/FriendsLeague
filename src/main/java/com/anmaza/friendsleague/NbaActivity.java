                ...
                if (!nameleague.isEmpty() && !numberof.isEmpty()) {
                    ...
                    if (usuarios.size() == Integer.parseInt(numberof)) {
                        ...
                        if (usuarios.size() >= 2) {
                                    ...
                                    .setValue(ligas).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                Toast.makeText(NbaActivity.this, "Liga Creada!!!", Toast.LENGTH_SHORT).show();
                                                usuarios.clear();
                                                finish();
                                            }
                                        }
                            ...
                            Toast.makeText(NbaActivity.this, "El nº de participantes debe ser mayor de 2", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(NbaActivity.this, "El nº de participantes no coincide", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(NbaActivity.this, "Debes rellenar los campos", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public void addUsers(View v) {
        ...
        if (!name.isEmpty()) {
            ...
            if (!nameEquals) {
                ...
                Toast.makeText(NbaActivity.this, "El usuario no puede repetirse", Toast.LENGTH_SHORT).show();
            }
            nombres.setText("");

        } else {
            Toast.makeText(NbaActivity.this, "Debes rellenar antes el campo nombre", Toast.LENGTH_SHORT).show();
        }
    }
}
